...
console.log(product2.sell(10)); // { name: 'Samsung Galaxy S24 Ultra 1 tb', quantity: 65 }
console.log(product3.restock(50)); // 200
console.log(product4.isInStock()); // true
console.log(product1.comparePrice(product2)); // 200
